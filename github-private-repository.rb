...
# GitHubPrivateRepositoryReleaseDownloadStrategy downloads tarballs from GitHub Release assets. To use it, add
# `:using => GitHubPrivateRepositoryReleaseDownloadStrategy` to the URL section of your formula.
# This download strategy uses a GitHub Access Token (in the environment variable HOMEBREW_GITHUB_API_TOKEN)
# to sign the request.
